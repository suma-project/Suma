...
describe('SumaClient.vue', () => {
  ...
  test('Update select options', async () => {
    ...
    expect(data.locationtitle).toBe("Sample Headcount Initiative | West Wing | Quiet Reading Room | below quiet with desc")
    ...
    expect(data.showcounts).toBe(true)
    expect(data.locationtitle).toBe("Sample Headcount Initiative | West Wing | Quiet Reading Room | no desc")
    ...
    expect(data.showcounts).toBe(true)
    expect(data.locationtitle).toBe("test | location test")
    expect(data.locationDescription).toBe("")
