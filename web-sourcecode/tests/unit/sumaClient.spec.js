...
describe('SumaClient.vue', () => {
  ...
  test('Update select options', async () => {
    ...
    expect(data.location).toBe("")
    expect(data.showcounts).toBe(false)
    expect(data.activities).toEqual({"1":{"id":1,"title":"Type","rank":1,"required":true,"allowMulti":true,"description":"","options":[{"id":1,"title":"Reading","rank":0,"groupId":1},{"id":2,"title":"Computing","rank":1,"groupId":1},{"id":3,"title":"Collaborating","rank":2,"groupId":1},{"id":4,"title":"Training/Class","rank":3,"groupId":1}]},"2":{"id":2,"title":"Medium","rank":2,"required":false,"allowMulti":true,"description":"","options":[{"id":5,"title":"In-Person","rank":4,"groupId":2},{"id":6,"title":"Online","rank":5,"groupId":2}]}})
