...
angular.module('sumaAnalysis')
  .controller('CalendarCtrl', function ($scope, $http, $timeout, initiatives, actsLocs, data, promiseTracker, uiStates, errorDispatcher) {
    ...
    $scope.submit = function () {
      ...
      data.get($scope.params, $scope.activities, $scope.locations, 'processCalendarData')
