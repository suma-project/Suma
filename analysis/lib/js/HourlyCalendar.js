var HourlyCalendar = function () {
    function hourlyCalendarChart(selection) {
        var margin = { top: 50, right: 0, bottom: 100, left: 30 },
            ...
            daysTitle = {'1': 'Sunday', '2': 'Monday', '3': 'Tuesday', '4': 'Wednesday', '5': 'Thursday', '6': 'Friday', '7': 'Saturday'},
        ...
        function setTitle(d) {
            ...
            return daysTitle[d.day] + ' ' + timesTitle[d.hour] + '<p>' + count + '</p>';
        }
        ...
        selection.each(function (counts) {
            ...
            // Append day labels
            dayLabels = svgEnter.selectAll(".dayLabel")
                .data(days)
                .enter().append("text")
            ...
            // Append hour labels
            timeLabels = svgEnter.selectAll(".timeLabel")
                .data(times)
                .enter().append("text")
                .text(function (d) { return d; })
