...
angular.module('actsLocsMock', [])
  .value('init', {
    ...
    'activities': [{'id':18,'rank':0,'title':'Type','type':'activityGroup','depth':0,'filter':'allow','enabled':true},{'id':48,'rank':0,'title':'Print/Copy','type':'activity','depth':1,'activityGroup':18,'filter':'allow','enabled':true},{'id':49,'rank':1,'title':'Reference','type':'activity','depth':1,'activityGroup':18,'filter':'allow','enabled':true},{'id':50,'rank':2,'title':'Directional','type':'activity','depth':1,'activityGroup':18,'filter':'allow','enabled':true},{'id':51,'rank':3,'title':'Computing','type':'activity','depth':1,'activityGroup':18,'filter':'allow','enabled':true},{'id':19,'rank':1,'title':'Medium','type':'activityGroup','depth':0,'filter':'allow','enabled':true},{'id':52,'rank':0,'title':'In-person','type':'activity','depth':1,'activityGroup':19,'filter':'allow','enabled':true},{'id':53,'rank':1,'title':'Phone','type':'activity','depth':1,'activityGroup':19,'filter':'allow','enabled':true},{'id':58,'rank':2,'title':'Roaming','type':'activity','depth':1,'activityGroup':19,'filter':'allow','enabled':true},{'id':20,'rank':2,'title':'Time','type':'activityGroup','depth':0,'filter':'allow','enabled':true},{'id':54,'rank':0,'title':'Very short (&lt; 5 seconds)','type':'activity','depth':1,'activityGroup':20,'filter':'allow','enabled':true},{'id':55,'rank':1,'title':'Short (&lt; 5 minutes)','type':'activity','depth':1,'activityGroup':20,'filter':'allow','enabled':true},{'id':56,'rank':2,'title':'Medium (5-10 minutes)','type':'activity','depth':1,'activityGroup':20,'filter':'allow','enabled':true},{'id':57,'rank':3,'title':'Long (&gt; 10 minutes)','type':'activity','depth':1,'activityGroup':20,'filter':'allow','enabled':true},{'id':-2,'rank':9999,'title':'No Activity','type':'activityGroup','depth':0,'filter':'allow','enabled':true},{'id':-1,'rank':0,'title':'No Activity','type':'activity','depth':1,'activityGroup':-2,'filter':'allow','enabled':true}],
    'locations': [{
      'title': 'All',
      'id': 'all'
    }, {
